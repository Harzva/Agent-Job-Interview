<div align="center">
  <h1>Agent Job Interview / Interview App</h1>
  <p><strong>统一仓库中的面试题库子应用：面向 Agent 岗位的能力地图、公司专项、项目案例和学习路径。</strong></p>
  <p>
    <a href="https://harzva.github.io/Agent-Job-Interview/interview/">在线题库</a>
    ·
...
| 入口 | 地址 | 用途 |
| --- | --- | --- |
| 在线题库 | <https://harzva.github.io/Agent-Job-Interview/interview/> | 浏览题库、公司页和学习路径 |
| 数据文件 | [`public/data.json`](public/data.json) | 查看题库原始结构 |
| 发布目录 | [`../../docs/interview/`](../../docs/interview/) | GitHub Pages 使用的静态产物 |
